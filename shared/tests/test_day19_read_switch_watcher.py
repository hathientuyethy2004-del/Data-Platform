...
from shared.platform.migration_templates.day19_read_switch_watcher import update_day18_19_checklist
...
def test_update_day19_keeps_unchecked_when_blocked(tmp_path: Path):
...
def test_update_day19_marks_when_switched_50_and_monitoring_pass(tmp_path: Path):
    checklist = tmp_path / "MIGRATION_CHECKLIST_30_DAYS.md"
    checklist.write_text(_checklist_text(), encoding="utf-8")

    report = {
        "summary": {"status": "READ_SWITCHED_50"},
